...
Route::get('/catalogs/{catalog}', [App\Http\Controllers\CatalogController::class, 'update']);
...
Route::get('/publishers/{publisher}', [App\Http\Controllers\PublisherController::class, 'update']);
Route::delete('/publishers/{pulisher}', [App\Http\Controllers\PublisherController::class, 'destroy']);
